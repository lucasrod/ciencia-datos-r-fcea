...
## ✅ Alternativa 2: Histograma facetado de `log(gdpPercap)` por año
...
## ✅ Alternativa 3: Violin plots por año

### Qué muestra:

-   Dispersión y forma de la distribución de `gdpPercap` por año.
-   Muy visual y fácil de leer, pero **no facetás**, sino que ponés años en el eje x.

```{r}
ggplot(gapminder, aes(x = factor(year), y = gdpPercap, fill = continent)) +
  geom_violin(scale = "width", draw_quantiles = c(0.5)) +
  scale_y_log10(labels = scales::dollar_format()) +
  labs(
    title = "Distribución del PIB per cápita por año y continente",
    x = "Año",
