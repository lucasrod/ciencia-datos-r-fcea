...
> **Interpretación**\
> - Los **violines** confirman el ranking histórico: Europa y Oceanía siempre arriba. Asia arranca abajo pero muestra cierto despegue, sobre todo en la segunda mitad del período. África, en cambio, parece casi estancada: su forma apenas cambia y sigue muy por debajo del resto.
>
...
grafico_interactivo <- ggplot(gapminder, aes(x = gdpPercap, y = lifeExp, color = continent, text = paste("País:", country, "<br>Año:", year))) +
  geom_point(alpha = 0.5) +
  scale_x_log10(labels = scales::dollar_format()) +
  labs(
