...
> Todas las acciones indicadas aquí deben implementarse en la _recipe_ preliminar o en pasos de ingeniería previos al ajuste de modelos en `HW2.qmd`.
...
| BsmtFin_SF_1        | 8            | _depende del modelo_ | revisar linealidad |
| Bedroom_AbvGr       | 8            | _factor_ **o** numérica | distribución sesgada |
| Mo_Sold             | 12           | `factor(ordered = TRUE)` | estacionalidad |
| TotRms_AbvGrd       | 14           | _factor_ **si** no lineal | revisión visual |
